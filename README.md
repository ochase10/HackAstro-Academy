...
-   Attaining confidence in writing and running programs using good 
    development habits

-   Using Numpy, AstroPy and other packages to process and manipulate
    data

-   Visualizing data and functions using Matplotlib

-   Using Git and GitHub for version control and collaboration

-   Articulating the differences and advantages of different
...
Below is an approximate schedule of class meetings and curriculum.

| Week | Topics|
|:---:|-------------|
| 1 | <ul><li>Syllabus overview and logistics</li><li>Installing Python</li><li>Intro to bash</li></ul>|
| 2 | <ul><li>Hello, World</li><li>Thinking like a programmer</li><li>Text editors</li></ul>|      
| 3 | <ul><li>Control Flow</li><li>Data Types</li></ul>   
| 4 | <ul><li>Control Flow (cont.)</li><li>Review</li></ul> 
| 5 | <ul><li>Functions</li><li>File I/O</li></ul>  
| 6 | <ul><li>Packages</li><li>Numpy</li></ul>  
| 7 | <ul><li>Numpy</li><li>Matplotlib</li></ul>
| 8 | <ul><li>Astropy</li><li>FITs files</li></ul>
| 9 | <ul><li>Pandas</li><li>Data Science</li></ul>
| 10 | <ul><li>Model Fitting</li><li>MCMC</li></ul>
| 11 | <ul><li>Git</li><li>GitHub</li></ul>
| 12 | <ul><li>Using LLMs</li></ul>
| 13 | <ul><li>Projects</li><li>Advanced Topics</li></ul>
| 14 | <ul><li>Projcts</li><li>Advanced Topics</li></ul>
